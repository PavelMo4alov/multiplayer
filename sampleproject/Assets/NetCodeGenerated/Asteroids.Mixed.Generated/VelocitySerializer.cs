...
{
    [BurstCompile]
    public struct VelocityGhostComponentSerializer
    {
        static VelocityGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 5695069450399240654,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<Velocity>(),
                ComponentSize = UnsafeUtility.SizeOf<Velocity>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<Velocity>(componentData, componentStride*i);
        ...
        private static void CopyFromSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                component.Value = math.lerp(
                    new float2(snapshotBefore.Value_x * 0.01f, snapshotBefore.Value_y * 0.01f),
                    new float2(snapshotAfter.Value_x * 0.01f, snapshotAfter.Value_y * 0.01f),
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<Velocity>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<Velocity>(backupData, 0);
