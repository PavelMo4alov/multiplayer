...
{
    [BurstCompile]
    public struct ShipStateComponentDataGhostComponentSerializer
    {
        static ShipStateComponentDataGhostComponentSerializer()
        {
            State = new GhostComponentSerializer.State
            {
                GhostFieldsHash = 14767913548786401661,
                ExcludeFromComponentCollectionHash = 0,
                ComponentType = ComponentType.ReadWrite<ShipStateComponentData>(),
                ComponentSize = UnsafeUtility.SizeOf<ShipStateComponentData>(),
        ...
        private static void CopyToSnapshot(IntPtr stateData, IntPtr snapshotData, int snapshotOffset, int snapshotStride, IntPtr componentData, int componentStride, int count)
        {
            for (int i = 0; i < count; ++i)
            {
                ...
                ref var component = ref GhostComponentSerializer.TypeCast<ShipStateComponentData>(componentData, componentStride*i);
        ...
        {
            ref var component = ref GhostComponentSerializer.TypeCast<ShipStateComponentData>(componentData, 0);
            ref var backup = ref GhostComponentSerializer.TypeCast<ShipStateComponentData>(backupData, 0);
